...
{
  0x0c, 0x96, 0xdc, 0x62, 0x02, 0x16, 0x9d, 0xb5, 0x5a, 0x45, 0x1d, 0xe1, 0xe1, 0xb7, 0x07, 0x5f, 
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_24) = {
  .len = 16,
  .data = { 0x5c, 0x02, 0x6e, 0x74, 0x62, 0x09, 0x24, 0xaf, 0x21, 0x4b, 0x80, 0x9d, 0xe2, 0x78, 0x51, 0xfd, }
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x1b, .uuid = 0x8000, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x00, .constdata = &gattdb_attribute_field_26 },
  ...
  { .handle = 0x1e, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x08, .char_uuid = 0x8001 } },
  { .handle = 0x1f, .uuid = 0x8001, .permissions = 0x802, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
};
